...
export const interviewAnswers: InterviewAnswer[] = [
  ...
  {
    questionNumber: 16,
    question: "LMS (Learning Management System) projelerinde deneyiminiz var mı?",
    answer: "AdPro projesinde React Native ile AI destekli bir LMS sistemi geliştirdim. Google Gemini AI entegrasyonu ile kişiselleştirilmiş öğrenme deneyimi sağladık. Özellikle quantum dashboard'daki pattern recognition algoritmalarını eğitim içerik analizi için uyarladım. Real-time progress tracking, adaptive learning paths ve AI-powered content recommendations özellikleri ekledik. Kullanıcıların öğrenme hızına göre içerik zorluğunu otomatik ayarlayan sistem geliştirdik. Ayrıca gamification elementleri ve social learning features ile engagement rate'i %60 artırdık.",
    projects: ["adpro", "ai-algo-trade"],
    technologies: ["React Native", "Google Gemini AI", "TensorFlow", "Real-time Analytics"],
    confidence: 92,
    category: "Education"
  ...
  {
    questionNumber: 18,
    question: "Frontend teknolojilerinde hangi framework'leri kullandınız?",
    answer: "Frontend teknolojilerinde kapsamlı deneyimim var. Next.js 14 ile SSR/SSG optimizasyonları, React 18 ile concurrent features, ve TypeScript ile type safety sağladım. Quantum dashboard'da Framer Motion ile advanced animations, glassmorphism efektleri ve 3D transforms kullandım. Tailwind CSS ile utility-first yaklaşım ve custom design systems geliştirdim. Özellikle AI Algo Trade projesinde real-time data visualization, WebSocket entegrasyonu ve complex state management çözümleri uyguladım. Performance optimization için code splitting, lazy loading ve bundle analysis teknikleri kullandım.",
    projects: ["ai-algo-trade", "adpro", "oto-mansuroglu"],
    technologies: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Framer Motion", "WebSocket"],
    confidence: 98,
    category: "Frontend"
  },
  {
    questionNumber: 21,
    question: "Backend teknolojilerinde hangi dilleri ve framework'leri kullandınız?",
    answer: "Backend teknolojilerinde Python, Node.js ve PHP kullandım. AI Algo Trade projesinde Python ile FastAPI, SQLAlchemy ve Redis kullanarak high-performance trading API'si geliştirdim. MetaTrader 5 entegrasyonu ile real-time market data processing ve order execution sistemi kurduk. Quantum AI models (LSTM, Transformer, GRU) ile pattern recognition ve price prediction algoritmaları geliştirdim. Microservices architecture ile scalable ve fault-tolerant sistem tasarladık. Ayrıca WebSocket ile real-time communication, Redis ile caching ve PostgreSQL ile ACID compliant database yapısı kurduk.",
    projects: ["ai-algo-trade", "slack-integration"],
    technologies: ["Python", "FastAPI", "Node.js", "PostgreSQL", "Redis", "WebSocket"],
    confidence: 96,
    category: "Backend"
  ...
  {
    questionNumber: 27,
    question: "Mobil uygulama geliştirme deneyiminiz var mı?",
    answer: "React Native ile cross-platform mobil uygulamalar geliştirdim. AdPro projesinde AI destekli eğitim uygulaması geliştirdik. Google Gemini AI entegrasyonu ile natural language processing, image recognition ve personalized content generation özellikleri ekledik. Quantum dashboard'daki real-time analytics ve pattern recognition özelliklerini mobil platforma uyarladık. Performance optimization için lazy loading, image optimization ve memory management teknikleri kullandım. Ayrıca push notifications, offline support ve deep linking özellikleri ekledik. App Store ve Google Play Store'da başarıyla yayınladık.",
    projects: ["adpro", "ai-algo-trade"],
    technologies: ["React Native", "Google Gemini AI", "TensorFlow", "Push Notifications"],
    confidence: 94,
    category: "Mobile"
  },
  {
    questionNumber: 28,
    question: "Real-time uygulamalar geliştirdiniz mi?",
    answer: "AI Algo Trade projesinde kapsamlı real-time trading sistemi geliştirdim. WebSocket ile real-time market data streaming, live order execution ve portfolio monitoring sistemi kurduk. Quantum dashboard'da real-time pattern recognition, AI model predictions ve market sentiment analysis özellikleri geliştirdik. Slack Integration projesinde real-time customer service automation ve AI-powered response generation sistemi kurduk. Redis pub/sub ile real-time notifications, Socket.io ile live chat ve real-time analytics dashboard'ları geliştirdik. Performance için connection pooling, message queuing ve load balancing teknikleri kullandım.",
    projects: ["ai-algo-trade", "slack-integration"],
    technologies: ["WebSocket", "Socket.io", "Redis", "Real-time Analytics"],
    confidence: 97,
    category: "Real-time"
  },
  {
    questionNumber: 30,
    question: "Web uygulamalarında güvenlik konularında deneyiminiz var mı?",
    answer: "Tüm projelerimde güvenlik en öncelikli konulardan biri. OAuth 2.0 ve JWT ile secure authentication, HTTPS enforcement ve CORS policy implementation yaptım. SQL injection, XSS ve CSRF saldırılarına karşı koruma sağladım. AI Algo Trade projesinde API rate limiting, input validation ve secure WebSocket connections kurduk. Quantum dashboard'da sensitive financial data için encryption ve secure data transmission protokolleri kullandım. PCI DSS uyumlu ödeme sistemleri, secure API endpoints ve audit logging sistemleri geliştirdik. Ayrıca penetration testing ve security audits gerçekleştirdik.",
    projects: ["ai-algo-trade", "oto-mansuroglu", "slack-integration"],
    technologies: ["OAuth 2.0", "JWT", "HTTPS", "Encryption", "PCI DSS"],
    confidence: 93,
    category: "Security"
  },
  {
    questionNumber: 31,
    question: "SEO ve performans optimizasyonu konularında deneyiminiz var mı?",
    answer: "Next.js ile SSR/SSG optimizasyonları, meta tags management ve structured data implementation yaptım. Core Web Vitals optimizasyonu için image optimization, code splitting ve lazy loading teknikleri kullandım. Quantum dashboard'da real-time performance monitoring ve analytics sistemi kurduk. Lighthouse scores'ları 90+ seviyesine çıkardık. SEO için semantic HTML, schema markup ve sitemap generation otomasyonu geliştirdik. Performance için CDN integration, caching strategies ve bundle optimization teknikleri uyguladık. Ayrıca A/B testing ile conversion rate optimization çalışmaları yaptık.",
    projects: ["ai-algo-trade", "oto-mansuroglu", "adpro"],
    technologies: ["Next.js", "Core Web Vitals", "Lighthouse", "CDN", "Caching"],
    confidence: 91,
    category: "Performance"
  },
  {
    questionNumber: 32,
    question: "Karmaşık problemleri nasıl çözüyorsunuz?",
    answer: "Solar Analysis projesinde AI destekli güneş paneli anomali tespiti için complex machine learning algoritmaları geliştirdim. Quantum dashboard'da real-time pattern recognition ve market prediction için ensemble AI models kullandım. Problem çözme sürecimde: 1) Problem analizi ve requirement gathering, 2) Technical research ve solution design, 3) Prototype development ve testing, 4) Iterative improvement ve optimization. AI Algo Trade projesinde MetaTrader 5 entegrasyonu, real-time data processing ve automated trading sistemi gibi karmaşık problemleri başarıyla çözdüm. Ayrıca team collaboration ve code review süreçlerinde aktif rol aldım.",
    projects: ["solar-analysis", "ai-algo-trade"],
    technologies: ["Machine Learning", "AI", "Problem Solving", "System Design"],
    confidence: 95,
    category: "Problem Solving"
  },
  {
    questionNumber: 34,
    question: "Sıkı deadline'larda nasıl çalışıyorsunuz?",
    answer: "AI Algo Trade projesinde 3 aylık sürede production-ready quantum trading platform geliştirdim. Agile metodolojisi ile sprint planning, daily standups ve continuous integration kullandım. Priority-based task management ve time tracking ile efficient workflow kurduk. Quantum dashboard'ı 2 haftada geliştirip deploy ettik. Critical path analysis ve risk management ile potential bottlenecks'leri önceden tespit ettik. Team collaboration için Git workflow, code review ve pair programming teknikleri kullandım. Ayrıca automated testing ve CI/CD pipeline ile development velocity'yi artırdık. Deadline'lara %100 uyum sağladık.",
    projects: ["ai-algo-trade", "quantum-dashboard"],
    technologies: ["Agile", "Git", "CI/CD", "Project Management"],
    confidence: 96,
    category: "Project Management"
  }
]
